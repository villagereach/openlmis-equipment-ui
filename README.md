# OpenLMIS Equipment UI Module
This repository is the UI for the [OpenLMIS Equipment Service.](https://github.com/villagereach/openlmis-equipment-ui)
...
1. Fork/clone this repository from GitHub.
 ...
 ```shell
 git clone https://github.com/villagereach/openlmis-equipment-ui
 ```
2. Develop w/ Docker by running `docker-compose run --service-ports equipment-ui`.
